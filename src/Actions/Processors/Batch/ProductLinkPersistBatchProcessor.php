...
/**
 * TechDivision\Import\Product\Link\Actions\Processors\Batch\ProductLinkPersistBatchProcessor
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The product link persist batch processor implementation.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2015 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class ProductLinkPersistBatchProcessor extends AbstractPersistBatchProcessor
{
    ...
    {
        return SqlStatements::CREATE_PRODUCT_LINK;
    }
